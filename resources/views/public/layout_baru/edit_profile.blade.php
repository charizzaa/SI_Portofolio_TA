...
<div class="container mx-auto w-96">
    <div class="justify-start">
        <div class="flex justify-center">
            <div class="relative">
                <img src="{{ asset('asset/profile.webp') }}" alt="Profile Picture" class="w-32 h-32 rounded-full object-cover">
        ...
        <form action="" class="mt-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="last-name" name="lastname" value="{{ $content['last_name'] }}" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
            <div class="mb-4">
