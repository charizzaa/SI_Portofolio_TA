...
<div class="container mx-auto w-96">
    <div class="justify-start">
        ...
        <form class="mt-6">
            ...
            <button type="submit" class="w-full bg-teal-800 text-white py-2 px-4 rounded-md shadow-sm hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Simpan Perubahan</button>
        </form>
    </div>
</div>
<br><br>
