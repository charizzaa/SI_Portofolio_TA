...
<div class="container mx-auto p-4 mb-12">
    <h1 class="text-4xl font-bold text-center mb-12">Tambah Portofolio Tugas Akhir</h1>
    <div class="p-6 rounded-lg">

        <form action="{{ route('public.store_portfolio') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <p>Pilih beberapa tag dengan menekan Ctrl (Windows) atau Command (Mac)</p>
                <select class="form-select mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" name=" tags[]" multiple="multiple" id="tag">
            ...
            <div class="mb-4">
                ...
                <textarea id="video_tittle" name="video_tittle" rows="1" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
            </div>
            <div class="mb-4">
                <label for="video_url" class="block text-base font-medium text-gray-700">Tautan Video</label>
                <textarea id="video_url" name="video_url" rows="1" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
            </div>
            <div class="mb-4">
