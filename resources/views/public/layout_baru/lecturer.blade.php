    ...
    <div class="flex">
        <div id="kontent1_kanan" class="relative bg-slate-200" style="width: 300px; height: 400px;">
            <div class="z-10 absolute top-0 start-0 bg-white rounded-2xl shadow-2xl shadow-teal-800">
                <img src="{{ $contents['image_profile']?? asset('asset/profile.webp') }}" alt="" style="width: 300px; height: 400px;">
            </div>
...
<p class="text-5xl text-teal-800 font-bold mb-24 text-center">Bidang Keahlian</p>
