...
<html lang="en">
  ...
  <div
    ...
    >
        ...
        <div class="flex flex-row items-center justify-center mt-9">

              <img
                style="border-radius: 15px; width: 450px; height: 400px"
              ...
              >
                <p
                  class="mb-2 text-2xl tracking-tight text-white dark:text-white text-center"
                >
                  Creator
                </p>
                <h3
          ...
          <p class="mt-12 text-white text-3xl">Keyword:</p>
          <div class="flex mt-5 mb-5">
            <button
              class="bg-white text-black-900 border border-gray-300 px-4 py-2 square-full mr-5"
            >
              Button 1
            </button>
            <button
            ...
            <button
              class="bg-white text-black-900 border border-gray-300 px-4 py-2 square-full"
            >
              Button 3
            </button>
          </div>
          <div class="mt-5 mb-5 border-b border-white border-2"></div>
          ...
          >
          <p style="color: black;">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda ipsa obcaecati eligendi. Ab expedita fugit error? Labore quas deleniti in numquam voluptatibus, nobis nulla doloremque reiciendis asperiores molestiae alias rem.
            Laboriosam totam veritatis qui facilis non ab, consequatur cumque, enim dolor, placeat porro eius aut id itaque. Laboriosam earum adipisci ipsa aut neque. Quasi molestias ex tempora sapiente? Quisquam, ab.
            Provident totam repellat tempore in optio facere error nobis possimus earum quos doloremque sequi et porro nostrum, eligendi deserunt officia veniam eaque iure, fuga similique cumque repellendus asperiores. Porro, quas?
            Aliquid, optio. Reprehenderit minima facere molestias ipsa? Dolor repellendus est cum voluptate id porro ipsa, architecto magni doloribus quidem voluptatum asperiores similique maiores veniam reiciendis, minus, nam amet totam optio.
            Sapiente alias, nam dolores assumenda animi blanditiis eum ducimus id impedit cupiditate. Cupiditate est, harum omnis suscipit dolor excepturi, vel eum dolores voluptas modi odio voluptate placeat, ab maiores sapiente.
          </p>
          </div>
